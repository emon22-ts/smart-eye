...
const DICT = {
  ...
  "amodal.guestNote":   { en: "No account needed. Guest screenings are not saved to history.", bn: "কোনো অ্যাকাউন্ট লাগবে না। অতিথি স্ক্রিনিং ইতিহাসে সংরক্ষিত হয় না।" },
  "auth.cancel":        { en: "Cancel", bn: "বাতিল" },
  "auth.signInRequired": { en: "Please sign in or continue as guest to use Smart Eye.", bn: "Smart Eye ব্যবহার করতে সাইন ইন করুন বা অতিথি হিসেবে চালিয়ে যান।" },
  "gate.title":         { en: "Sign in to continue", bn: "চালিয়ে যেতে সাইন ইন করুন" },
  "gate.body":          { en: "Sign in or continue as guest to use this feature. Guest sessions work exactly the same — they're just not saved to your history.", bn: "এই ফিচারটি ব্যবহার করতে সাইন ইন করুন বা অতিথি হিসেবে চালিয়ে যান। অতিথি সেশন একইভাবে কাজ করে — শুধু আপনার ইতিহাসে সংরক্ষিত হয় না।" },
  "gate.cta":           { en: "Sign in or continue as guest", bn: "সাইন ইন বা অতিথি হিসেবে চালিয়ে যান" },
